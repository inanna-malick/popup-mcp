/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cee1cbcd670e9fc959b252caa8410236)
// Runtime types generated with workerd@1.20250927.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PopupSession" | "PopupMcpAgent";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		POPUP_SESSION: DurableObjectNamespace<import("./src/index").PopupSession>;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").PopupMcpAgent>;
	}
}
