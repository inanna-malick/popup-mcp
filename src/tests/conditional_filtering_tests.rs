...
mod tests {
    ...
    #[test]
    fn test_choice_based_conditional_filtering() {
        let json = json!({
        ...
        // Switch to "Advanced" (index 1)
        *state.get_choice_mut("Mode").unwrap() = 1;
        ...
        // Switch to "Expert" (index 2)
        *state.get_choice_mut("Mode").unwrap() = 2;
    ...
    #[test]
    fn test_multiple_conditionals_same_level() {
        let json = json!({
        ...
        assert!(active_labels.contains(&"Platform".to_string()));
        assert!(active_labels.contains(&"Web URL".to_string()));
        assert!(!active_labels.contains(&"Push Notifications".to_string()));
        assert!(!active_labels.contains(&"Window Size".to_string()));

        // Switch to Mobile
        *state.get_choice_mut("Platform").unwrap() = 1;
        ...
        // Switch to Desktop
        *state.get_choice_mut("Platform").unwrap() = 2;
